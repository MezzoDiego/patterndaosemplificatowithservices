...
public class UserDAOImpl extends AbstractMySQLDAO implements UserDAO {
	...
	@Override
	public List<User> cercaTuttiQuelliCreatiPrimaDi(java.util.Date dataConfronto) throws Exception {
		// prima di tutto cerchiamo di capire se possiamo effettuare le operazioni
		if (isNotActive())
			throw new Exception("Connessione non attiva. Impossibile effettuare operazioni DAO.");
	...
	public List<User> cercaPerCognomeENomeCheInziaCon(String cognomeInput, String inzialeNomeInput) throws Exception {
		...
		if (cognomeInput == null || inzialeNomeInput == null)
			throw new Exception("Valori di input non ammessi.");

		User temp = null;
		List<User> result = new ArrayList<>();
		try (PreparedStatement ps = connection
				.prepareStatement("select * from user where nome like ? and cognome = ?")) {
	...
	public User accedi(String loginInput, String passwordInput) throws Exception {
		...
		if (loginInput == null || loginInput == null)
			throw new Exception("Valori di input non ammessi.");
	...
	public int deleteAll() throws Exception {
		...
		try (Statement s = connection.createStatement()) {
			result = s.executeUpdate("DELETE FROM user");
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		}
